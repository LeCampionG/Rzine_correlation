...
<p class="center"> [<img src="figures/zip.png" width="50"/> **Télécharger les données**](https://gitlab.huma-num.fr/glecampion/correlation/-/raw/master/woman_speak.zip) </p>
...
ggplot(hist_cor, aes(x =reorder(term, year), y = year, fill=correlation)) +
      ...
      ylab("corrélation") +
      xlab("Variables") +
      scale_fill_discrete(labels = c("Négative", "Postive"))
