...
<figcaption style="font-size:13px;">, <URL :https://imgs.xkcd.com/comics/correlation.png</figcaption>
...
<figure class="center">
  ...
  <figcaption style="font-size:13px;">tylervigen.com, 2020, <URL : http://tylervigen.com/spurious-correlations> </figcaption>
</figure>
...
<figure class="center">
  [<img src="figures/types_of_correlations.jpg" width="650"/>](https://statswithcats.files.wordpress.com/2010/11/types-of-correlations.jpg?w=640&h=660%3E){target="_blank"}
  <figcaption style="font-size:13px;">Stats With Cats Blog, 2020, A Typolofy of Data Relationships, <URL : https://statswithcats.files.wordpress.com/2010/11/types-of-correlations.jpg?w=640&h=660></figcaption>
</figure>
...
<br>   
<p class="center">[<span style="font-size: 230%;" class="glyphicon glyphicon-download-alt"></span> <br/> Télécharger les données](https://github.com/rzine-reviews/Rzine_correlation/raw/master/data.zip)</p>
